...
export const productFacts = {
  ...
  installScriptUrl: 'https://local.cloud/install.sh',
  installScriptCommand: 'curl -fsSL https://local.cloud/install.sh | sh',
  homebrewInstallCommand: 'brew install LocalGCloud/tap/localcloud',
