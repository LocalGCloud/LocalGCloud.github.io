...
Yes — LocalCloud is free for individual developers for evaluation, personal projects, learning, and testing. It is not licensed for commercial or production use. See the [Licensing page](/docs/licensing/) for details.
