...
Google-maintained emulator availability, installation, and behavior can change. Consult current Google documentation for the service you need. The table below describes only LocalCloud's reviewed contract.
</Callout>
...
<table>
  <thead><tr><th>Service</th><th>Evidence state</th><th>Implementation</th><th>Local boundary</th></tr></thead>
  <tbody>
...
A contract listing does not imply default startup, full parity, legal permission, or availability in a qualified assembled image. Review the [service detail](/services/), [compatibility matrix](/compatibility/), and [licensing reference](/docs/licensing/).
...
The reviewed LocalCloud proprietary license permits limited personal, non-commercial Individual Developer use and excludes employer/organization, internal-tool, cost-saving, commercial, and team-CI workflows. Technical examples are not a license grant.
