...
For agent-assisted fixture work, use the [LocalCloud Agent Skills](https://github.com/LocalGCloud/LocalGCloud.github.io/tree/main/agent-skills). The `localcloud-seed-data` skill guides agents to create deterministic local seed data with fake values, load it through the admin API or startup mount, and reset tests to a known state.
