...
LocalCloud includes a built-in web console at `http://localhost:24080`. It is served directly by the running LocalCloud container, so the console is available as soon as the gateway is healthy.
