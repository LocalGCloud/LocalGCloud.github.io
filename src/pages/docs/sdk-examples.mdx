...
For agent-assisted SDK test work, use the [LocalCloud Agent Skills](https://github.com/LocalGCloud/LocalGCloud.github.io/tree/main/agent-skills). The `localcloud-sdk-tests`, `localcloud-bigquery`, and `localcloud-pubsub` skills instruct agents to route standard Google Cloud SDKs to localhost, avoid real GCP credentials by default, and validate production behavior separately.
